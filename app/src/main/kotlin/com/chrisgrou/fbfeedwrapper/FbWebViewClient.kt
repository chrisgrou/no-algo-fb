...
private val INJECTED_ASSETS = listOf("feed_filter.js", "scroll_position.js", "nav_bar_watchdog.js")

/**
 * Injects the feed-filtering (Feature 1), scroll-position (Feature 2), and nav-bar
 * watchdog scripts after every page load, keeps facebook.com navigation inside the
